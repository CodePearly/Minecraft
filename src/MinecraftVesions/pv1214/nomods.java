...
public class nomods {
    ...
    private void chooseFilePath() {
        ...
        if (userSelection == JFileChooser.APPROVE_OPTION) {
            ...
            String saveFilePath = saveDirectory + "/1.21.4-Offline.zip";
    ...
    private void downloadFile(String saveFilePath) {
        String fileURL = "https://github.com/CodePearly/minecraft_PearlYapper3193/archive/refs/tags/1.21.4-Offline.zip";
