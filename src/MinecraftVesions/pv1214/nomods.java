...
public class nomods {
    ...
    public nomods() {
    	...
    	System.out.println("This is the nomods class");
        ...
        btnDownload.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                noModsFrame.dispose(); // Close the frame after downloading the file
            }
        });

        // Arrange components in the frame
        noModsFrame.getContentPane().setLayout(null);
        lblMessage.setBounds(50, 10, 300, 20);
        btnDownload.setBounds(150, 50, 100, 30);

        noModsFrame.getContentPane().add(lblMessage);
        noModsFrame.getContentPane().add(btnDownload);
        ...
        noModsFrame.getContentPane().add(btnIHaveAlready);
