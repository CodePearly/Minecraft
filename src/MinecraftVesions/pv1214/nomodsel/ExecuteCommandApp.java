...
public class ExecuteCommandApp {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The working directory is:" + workingDirectory + "\\minecraft_PearlYapper3193-1.21.4-Offline\\AT\\instances\\Minecraft1214withForge5412\\");
        workingDirectory = workingDirectory + "\\minecraft_PearlYapper3193-1.21.4-Offline\\AT\\";
